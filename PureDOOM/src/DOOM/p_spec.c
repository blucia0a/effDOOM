...
{
    /* Animated flats/textures are irrelevant for the E1x ASCII-art output.
     * Skipping the entire table walk avoids fatal lookups for WAD lumps
     * that the squashware WAD doesn't carry. */
    lastanim = anims;
}
